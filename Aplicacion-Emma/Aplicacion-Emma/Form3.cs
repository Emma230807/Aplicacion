    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    int r = DTGVv.SelectedRows.Count - 1;

                    DTGVv.Rows[r].Cells[0].Value = txcodigo.Text;
                    DTGVv.Rows[r].Cells[1].Value = txnombre.Text;
                    DTGVv.Rows[r].Cells[2].Value = txclasificacion.Text;
                    DTGVv.Rows[r].Cells[3].Value = txaño.Text;
                    DTGVv.Rows[r].Cells[4].Value = txcompañia.Text;
                    DTGVv.Rows[r].Cells[5].Value = txcategoria.Text;
                    DTGVv.Rows[r].Cells[6].Value = txgb.Text;
                    DTGVv.Rows[r].Cells[7].Value = txprecio.Text;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                txcodigo.Text = DTGVv.CurrentRow.Cells[0].Value.ToString();
                txnombre.Text = DTGVv.CurrentRow.Cells[1].Value.ToString();
                txclasificacion.Text = DTGVv.CurrentRow.Cells[2].Value.ToString();
                txaño.Text = DTGVv.CurrentRow.Cells[3].Value.ToString();
                txcompañia.Text = DTGVv.CurrentRow.Cells[4].Value.ToString();
                txcategoria.Text = DTGVv.CurrentRow.Cells[5].Value.ToString();
                txgb.Text = DTGVv.CurrentRow.Cells[6].Value.ToString();
                txprecio.Text = DTGVv.CurrentRow.Cells[7].Value.ToString();
