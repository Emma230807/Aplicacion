    ...
    public partial class Form7 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DTGVv.Rows[r2].Cells[4].Value = txunidades.Text;
                    DTGVv.Rows[r2].Cells[5].Value = txmedicamento.Text;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txunidades.Text = DTGVv.CurrentRow.Cells[4].Value.ToString();
                txmedicamento.Text = DTGVv.CurrentRow.Cells[5].Value.ToString();
                ...
                {
                    MessageBox.Show("Hay datos invalidos", "Validacion de datos", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
